...
template <typename GEN> void testPMinHash(GEN& rng, uint32_t hashSize,uint64_t dataSize, uint64_t numCycles) {
    {
        ...
        std::string root_path = "/mnt/c/projects/ProjectoTopicos/reduced_Genomes";
...
int main(int argc, char* argv[]) {
    ...
    testProbMinHash3a(rng, hashSize, dataSize, numCycles);
    testProbMinHash4(rng, hashSize, dataSize, numCycles);
